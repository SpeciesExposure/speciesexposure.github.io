    ...
    function(el, x) {
      ...
      var setHotspotYear = function(year) {
        hotspotYears.forEach(function(y) {
          ...
          if (pane) pane.style.display = String(y) === String(year) ? '' : 'none';
        });
      };
      ...
      map.on('click', function(e) {
        ...
        window._clickCell = L.rectangle(
          [[north - rasterYres, west], [north, west + rasterXres]],
          { color: '#ff2222', weight: 2, fill: false, interactive: false, pane: 'cellSelectPane' }
        ).addTo(map);
